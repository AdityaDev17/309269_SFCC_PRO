...
import { SearchIcon, X, Mic } from "lucide-react"
...
const SearchWithSuggestions = ({
  ...
  <div className={styles.inputRow}>
    <Button className={styles.search} aria-label="Search" onClick={handleSearch}>
    ...
    <div className={styles.suggestionsBox}>
      {suggestions.length > 0 ? (
            ...
            {suggestions.map((item, index) => (
              <li key={index} className={styles.suggestionItem}>
                ...
                >
                  ...
                  <span className={styles.suggestionText}>{item.question}</span>
                </button>
              </li>
            ))}
          </ul>
        ...
        <div className={styles.noResults}>
          ...
          <p className={styles.noResultsMessage}>Please try a different search term.</p>
        </div>
        </>
      )}
    </div>
